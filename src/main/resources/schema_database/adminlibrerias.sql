...
INSERT INTO `sucursal` (`id_sucursal`, `calle`, `numero_exterior`, `numero_interior`, `colonia`, `municipio`, `codigo_postal`, `pais`) VALUES
(1, 'Av. Siempre Viva', 742, 'A', 'Springfield', 'Springfield', 12345, 'Estados Unidos'),
(2, 'Calle Falsa', 123, 'B', 'Centro', 'Ciudad', 54321, 'México'),
(3, 'Boulevard del Sol', 5678, 'C', 'Mirador', 'Metropolis', 67890, 'Canadá'),
(4, 'Av. Principal', 1011, 'D', 'Oasis', 'Villa', 11111, 'Argentina'),
(5, 'Callejón Oscuro', 2122, 'E', 'Villa Nova', 'Pueblo', 22222, 'España'),
(6, 'Via Láctea', 3434, 'F', 'Galaxia', 'Cosmos', 33333, 'Italia'),
(7, 'Calle de la Luna', 4545, 'G', 'Luna Nueva', 'Selenópolis', 44444, 'Chile'),
(8, 'Camino Real', 5656, 'H', 'Antiguo', 'Ciudad Vieja', 55555, 'Perú'),
(9, 'Plaza Mayor', 6767, 'I', 'Histórica', 'Capital', 66666, 'Colombia'),
(10, 'Ruta Nacional', 7878, 'J', 'Patagonia', 'Andes', 77777, 'Argentina'),
(11, 'Pasaje del Sol', 8989, 'K', 'Verde', 'Paraíso', 88888, 'Venezuela'),
(12, 'Calle del Bosque', 9090, 'L', 'Arboleda', 'Ciudad Jardín', 99999, 'Brasil'),
(13, 'Av. de las Estrellas', 1111, 'M', 'Cielo Abierto', 'Cosmópolis', 10101, 'Ecuador'),
(14, 'Calle del Río', 2222, 'N', 'Riberas', 'Agua Clara', 20202, 'Guatemala'),
(15, 'Paseo del Mar', 3333, 'O', 'Playas', 'Costera', 30303, 'Uruguay');
